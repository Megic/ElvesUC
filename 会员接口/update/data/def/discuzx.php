...
//会员系统相关配置
$elve_config['member']['tablename']="数据库名.pre_common_member";	//会员表
$user_tablename=$elve_config['member']['tablename'];	//会员表
$elve_config['member']['changeregisterurl']="";    //多会员组中转注册地址
$elve_config['member']['registerurl']="http://localhost/discuzx/member.php?mod=register";							//会员注册地址
...
$elve_config['member']['utfdata']=0;//数据是否是UTF8编码,0为正常数据,1为UTF8编码

$elve_config['memberf']['userid']='uid';//用户ID字段
...
$elve_config['memberf']['registertime']='regdate';//注册时间字段
