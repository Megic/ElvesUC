...
$ecms_config['memberf']['password']='userpassword';//密码字段
$ecms_config['memberf']['rnd']='enewsrnd';//随机密码字段
$ecms_config['memberf']['email']='useremail';//邮箱字段
$ecms_config['memberf']['registertime']='joindate';//注册时间字段
