...
//会员系统相关配置
$elve_config['member']['tablename']="数据库名.e_user";	//会员表
$user_tablename=$elve_config['member']['tablename'];	//会员表
$elve_config['member']['changeregisterurl']="";    //多会员组中转注册地址
$elve_config['member']['registerurl']="http://localhost/ebb/register/";							//会员注册地址
...
$elve_config['member']['regtimetype']=0;//注册时间保存格式,0为正常时间,1为数值型
