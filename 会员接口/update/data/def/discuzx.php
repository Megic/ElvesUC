...
//会员系统相关配置
$ecms_config['member']['tablename']="数据库名.pre_common_member";	//会员表
$user_tablename=$ecms_config['member']['tablename'];	//会员表
$ecms_config['member']['changeregisterurl']="";    //多会员组中转注册地址
$ecms_config['member']['registerurl']="http://localhost/discuzx/member.php?mod=register";							//会员注册地址
...
$ecms_config['memberf']['userid']='uid';//用户ID字段
...
$ecms_config['memberf']['registertime']='regdate';//注册时间字段
