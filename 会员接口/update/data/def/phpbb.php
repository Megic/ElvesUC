...
$elve_config['memberf']['userid']='user_id';//用户ID字段
$elve_config['memberf']['username']='username';//用户名字段
$elve_config['memberf']['password']='user_password';//密码字段
$elve_config['memberf']['rnd']='melvernd';//随机密码字段
$elve_config['memberf']['email']='user_email';//邮箱字段
$elve_config['memberf']['registertime']='user_regdate';//注册时间字段
...
$elve_config['memberf']['salt']='melvesalt';//SALT加密字段
