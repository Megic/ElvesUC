...
//会员系统相关配置
$ecms_config['member']['tablename']="数据库名.phpbb_users";	//会员表
$user_tablename=$ecms_config['member']['tablename'];	//会员表
$ecms_config['member']['changeregisterurl']="";    //多会员组中转注册地址
$ecms_config['member']['registerurl']="http://localhost/phpbb/profile.php?mode=register";							//会员注册地址
...
$ecms_config['member']['utfdata']=1;//数据是否是UTF8编码,0为正常数据,1为UTF8编码

$ecms_config['memberf']['userid']='user_id';//用户ID字段
$ecms_config['memberf']['username']='username';//用户名字段
$ecms_config['memberf']['password']='user_password';//密码字段
$ecms_config['memberf']['rnd']='enewsrnd';//随机密码字段
$ecms_config['memberf']['email']='user_email';//邮箱字段
$ecms_config['memberf']['registertime']='user_regdate';//注册时间字段
