...
$elve_config['memberf']['password']='userpassword';//密码字段
$elve_config['memberf']['rnd']='melvernd';//随机密码字段
$elve_config['memberf']['email']='useremail';//邮箱字段
